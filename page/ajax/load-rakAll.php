...
// memanggil file config.php
    ...
    // echo $sql;
        ...
        $aksi = '
        <button href="#" class="btn btn-warning btn-sm mb-1 tombolEdit" data-nama_rak="'.$row['nama_rak'].'" data-no_rak="'.$row['no_rak']. '" ">
            <i class="glyphicon glyphicon-pencil"></i> EDIT
        </button>
        <button href="#" class="btn btn-danger btn-sm mb-1 tombolHapus" data-nama_rak="'.$row['nama_rak'].'" data-no_rak="'.$row['no_rak']. '" ">
