        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTambahMitraTitle">Tambah Barang</h5>
                ...
                <div class="modal-body">
                    <form id="formTambahMitra">
                        <div class="form-group">
                            <label for="inputJenisBarang">Jenis Barang <small class="text-danger"></small></label>
                ...
                <div class="modal-body">
                    <form id="formTambahMitra">
                        <div class="form-group">
                            <label for="inputSpesifikasi">Spesifikasi <small class="text-danger"></small></label>
                ...
                <div class="modal-body">
                    <form id="formTambahMitra">
                        <div class="form-group">
                            <label for="inputSatuan">Satuan <small class="text-danger"></small></label>
                ...
                <div class="modal-body">
                    <form id="formTambahMitra">
                        <div class="form-group">
                            <label for="inputRak">Nama Rak <small class="text-danger"></small></label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="tambahMitra"><i class="glyphicon glyphicon-plus"></i> Tambahkan Barang</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var dataTable = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "page/ajax/load-barangAll.php",
                    "type": "POST",
                }
            });
            ...
            $('#tambahMitra').on('click', function() {
                ...
                if (nama_barang == '') {
                    ...
                    $('*[for="inputJenisBarang"] > small').html('Harap diisi!');
                } else if (spesifikasi == '') {
                    $('*[for="inputSpesifikasi"] > small').html('Harap diisi!');
                } else if (satuan == 'default') {
                    $('*[for="inputSatuan"] > small').html('Harap diisi!');
                } else if (rak == 'default') {
                    $('*[for="inputRak"] > small').html('Harap diisi!');
                } else {
