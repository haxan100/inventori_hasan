            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Admin : <?php echo $_SESSION['nm']; ?> </span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="?page=Rak"><i class="fa fa-book"></i> <span>Rak</span></a></li>
            <li><a href="laporanmasuk.php"><i class="fa fa-book"></i> <span>Laporan Barang Masuk</span></a></li>
            <li><a href="laporankeluar.php"><i class="fa fa-book"></i> <span>Laporan Barang Keluar</span></a></li>
                ...
                <div class="col-md-12">
                  ...
                  if ($page == 'user') {
                    ...
                    if ($aksi == "") {
                      ...
                      include "page/barangmasuk/barangmasukuser.php";
                    } elseif ($aksi == "tambah") {
                    ...
                    if ($aksi == "") {
                      ...
                      include "page/barangkeluar/barangkeluaruser.php";
                    } elseif ($aksi == "tambah") {
